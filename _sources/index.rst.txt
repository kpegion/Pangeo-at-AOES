...
The examples are also generally relevant for climate data analysis.  Therefore, an `External Tutorial`_ is also provided for those without access to the Mason AOES/COLA Servers.
